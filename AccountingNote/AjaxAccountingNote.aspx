    ...
    <script>
        $(function () {
            $("#btnSave").click(function () {
                ...
                if (id) {
                    $.ajax({
                        url: "http://localhost:63087/Handler/AccountingNoteHandler.ashx?ActionName=updata",
                        type: "POST",
                        data: {
                            "ID": id,
                            "Caption": caption,
                    ...
                    $.ajax({
                        url: "http://localhost:63087/Handler/AccountingNoteHandler.ashx?ActionName=create",
                        type: "POST",
                        data: {
                            "Caption": caption,
                            "Amount": amount,
            ...
            $("#btnDel").click(function () {
                ...
                $.ajax({
                    url: "http://localhost:63087/Handler/AccountingNoteHandler.ashx?ActionName=delete",
                    type: "POST",
                    data: {
                        "ID": id,
                        "Caption": caption,
            ...
            //    $.ajax({
            //        url: "http://localhost:63087/Handler/AccountingNoteHandler.ashx?ActionName=query",
            //        type: "POST",
            //        data: {
            //            "ID": 1039,
            //        },
            ...
            $.ajax({
                url: "http://localhost:63087/Handler/AccountingNoteHandler.ashx?ActionName=list",
                type: "GET",
                data: {},
                success: function (result) {
                        ...
                        var htmlText =    
                            `<tr>     
                                 ...
                                 <td>
                                        ...
                                        <img src="Image/search1.png" width="20" height="20"/></button>
                                 </td>
                            </tr>`;
                        table += htmlText;
                    }
...
<body>
    <form id="form1" runat="server">
                 ...
                 <tr>
                    <td>
                        ...
                        <br />
                            ...
                            <button type="button" id="btnDel">Delete Data</button>
                    </td>
                </tr>
            </table>   
        </div>
        ...
        <div id="divAccountingList"></div>    <%--<div/> 自我封閉-->變成一個欄位--%>
    </form>
</body>
</html>
